          ...
          children: [
            SingleChildScrollView(
              child: Column(
                children: [
                  // Home Section
                  Container(key: _homeKey, child: const SizedBox(height: 40)),
                  Padding(
            ...
            FloatingNavMobile(
              sections: [
                ...
                SectionItemMobile(label: 'Experience', icon: Icons.work_rounded, key: _experienceKey),
                SectionItemMobile(label: 'Projects', icon: Icons.apps_rounded, key: _projectsKey),
                SectionItemMobile(label: 'Contact', icon: Icons.mail_rounded, key: _contactKey),
              ],
            ),
          ],
        ),
