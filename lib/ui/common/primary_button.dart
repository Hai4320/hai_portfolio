      ...
      child: MouseRegion(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            color: hovering ? Colors.grey.withValues(alpha: 0.3) : Colors.transparent,
            gradient: hovering
          ...
          child: Center(
            child: Text(
              widget.label,
              style: const TextStyle(fontSize: 16, fontWeight: FontWeight.w500, color: AppColors.lightPeriwinkle),
            ),
          ),
        ),
      ),
